...
> **Historical report:** this file was generated by the earlier Python workflow.
> It does not describe the current Rust LFQ refresh. See the benchmark README
> and `pxd007683_lfq_rust_*.csv` for the refreshed piBAQ and LFQ results.
