...
Differential expression analysis identifies proteins whose abundance changes significantly between conditions. mokume offers LimROTS, DEqMS, proDA, limma, ROTS, and a top-k consensus ensemble — each suited to different priorities.
